...
#define TEMP_SENSOR 4 // Pin connected to the LM35 sensor
...
#define ADVERTISING_TIME 60000 // Advertising time in milliseconds
...
class MyServerCallbacks: public BLEServerCallbacks {
  ...
  // This function will be called when a device disconnects
...
void setup() {
  ...
  // Wait, the device needs to be connected during this time
  ...
  if (deviceConnected) {
    ...
    for (int i = 0; i < NUM_READINGS; i++) {
      ...
      String value = String(random(100));
